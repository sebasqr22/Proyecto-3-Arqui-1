...
export NTHREADS=1
time $GEM5_DIR/build/RISCV/gem5.opt -d m5out/ $GEM5_DIR/configs/deprecated/example/test.py -c $BENCHMARK -o "$NTHREADS $INPUT $OUTPUT" -I 1000000000 --cpu-type=NonCachingSimpleCPU --caches --l2cache --l1d_size=128kB -I 10000000 --cpu-type=NonCachingSimpleCPU --caches --l2cache --l1d_size=128kB --l1i_size=128kB --l2_size=1MB --l1d_assoc=2 --l1i_assoc=2 --l2_assoc=1 --cacheline_size=64 --bp-type=TournamentBP --replacement_policy=lru
